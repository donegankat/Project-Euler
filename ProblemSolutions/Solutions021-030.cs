...
namespace ProjectEuler.ProblemSolutions
{
    public static partial class Solutions
    {
		...
		public static void RunLexicographicalPermutationsProblem()
		{
			...
			var result = GetPermutations(stringToPermute.Substring(1), stringToPermute[0].ToString());
		...
		/// </string>
		private static List<string> GetPermutations(string word, string prefix = "")
		{
			...
			for (int i = 0; i < word.Length; i++)
			{
				...
				result.AddRange(GetPermutations(word.Remove(i, 1), prefix + word[i]));
			}
        ...
        {
			// TODO: Load the list of names from a file rather than hardcoding the name list. I'm just currently using a computer that doesn't
			// have .NET, and the online compiler I'm using can't load from a file.
            var filePath = "";
            ...
            var sortedFirstNames = firstNames.Split(',').OrderBy(name => name).ToArray();
